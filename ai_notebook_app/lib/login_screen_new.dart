...
// This file is unused – LoginScreen lives in login_screen.dart
class _LoginScreenUnused extends StatefulWidget {
  // ignore: unused_element
  const _LoginScreenUnused();

  @override
  State<_LoginScreenUnused> createState() => __LoginScreenUnusedState();
}

class __LoginScreenUnusedState extends State<_LoginScreenUnused> {
